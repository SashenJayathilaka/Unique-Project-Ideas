  ...
  return (
    <>
      ...
      <section className="relative">
        <div
          className="overflow-hidden flex after:content[''] after:dark:from-brand-dark after:to-transparent after:from-background after:bg-gradient-to-l after:right-0 after:bottom-0 after:w-20 after:absolute after:z-10
        after:content[''] before:dark:from-brand-dark before:to-transparent before:from-background before:bg-gradient-to-r before:left-0 before:bottom-0 before:w-20 before:absolute before:z-10"
        >
      ...
      <section className="relative">
        <div className="w-full blur-[120px] rounded-full h-32 absolute bg-brand-primaryPurple/50 -z-10 top-22" />
      ...
      <section className="mt-20 px-4 sm:px-6">
        <TitleSection
          ...
          pill="Pricing"
        />
        <div className="flex flex-col sm:flex-row gap-4 justify-center sm:items-stretch items-center mt-10">
          {PRICING_CARDS.toReversed().map((card, index) => (
            <CustomCard
              key={index}
              className={clsx(
              ...
              cardFooter={
                <ul className="font-normal flex mb-2 flex-col gap-4">
                  ...
                  {card.freatures.map((features, index) => (
